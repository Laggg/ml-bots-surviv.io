...
This bot tries to solve only **the locomotion problem** by training on human letsplays. To train this agent, we used 100 youtube-videos containing 1.2 million frames (equivalent to ~12 hours of gameplay recordings).
