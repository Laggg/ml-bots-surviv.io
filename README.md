...
*You can find [support project](https://github.com/Laggg/neural_env_surviv) for this global project  - Autoregressive neural environment for training an RL-agent (Open Data Science PetProject Hackathon (5.02.2022-20.02.2022)*  
